    ...
    <div className="fixed inset-0 bg-white dark:bg-slate-950 z-50 flex flex-col md:p-4">
      ...
      <div className="flex-1 overflow-y-auto px-4 w-full md:max-w-2xl md:mx-auto flex flex-col justify-center">
        <AnimatePresence mode="wait">
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-extrabold text-purple-600 dark:text-purple-400 tracking-tight leading-tight">
              {currentQ.question}
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              {currentQ.options.map((opt, i) => {
                ...
                let optionStyle = "border-slate-200 dark:border-slate-700 text-purple-600 dark:text-purple-400 hover:bg-purple-50/50 dark:hover:bg-purple-900/10";
                
                if (isSelected && !isChecked) {
                  optionStyle = "border-purple-400 bg-purple-50 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 ring-1 ring-purple-400";
                ...
                return (
                  <button
                    ...
                    className={classNames(
                      "p-4 sm:p-5 rounded-2xl border-2 border-b-4 text-left font-bold text-lg transition-all active:border-b-2 active:mt-[2px]",
                      optionStyle,
